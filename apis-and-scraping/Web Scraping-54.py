...
id_sel = parser.select("#second")
second_text = id_sel[0].text
...
pats = parser.select("#total-plays")[0]
patriots_total_plays_count = pats("td")[2].text

seas = parser.select("#total-yards")[0]
seahawks_total_yards_count = seas.select("td")[1].text